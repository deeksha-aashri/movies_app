...
export default class Favorites extends Component {
  constructor() {
    ...
    this.state = {
        movies:[],
        genre:[],
        currGenre:"All genre"//by default active in the list
    }
}
...
this.setState({
  ...
  {this.state.genre.map((genre)=>(
      ...
      :
      <li className="list-group-item " aria-current="true">{genre}</li>
      ...
      <div className="col">
        <div className="row-search" >
          <input type="text"  className="col-9"  placeholder="Search"></input>
          <input type="text"  className="col-3"  placeholder="Number of results to appear"></input>
        </div>
        <div className='row'>
        <table class="table">
  <thead>
